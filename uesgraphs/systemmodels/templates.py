...
class UESTemplates:
    ...
    def generate_new_template(self, path_library):
        ...
        self.logger = set_up_logger("UESModel", level=logging.DEBUG) #Log file stored in the temp directory. Regard also console output
        self.logger.info("UESModel Version: %s", __version__)
    ...
    def _generate_template_string(self, template_dict):
        ...
        template_str = f"  {self.model_name} {self.model_type.lower()}${{str(name)}}(\n"
