...
<%def name="get_main_parameters()">
   ...
   dp_nominal deltaM tau energyDynamics massDynamics sta_default cp_default cp_default_building m_flow_nominal m_flow_small show_T _m_flow_start _dp_start allowFlowReversal
