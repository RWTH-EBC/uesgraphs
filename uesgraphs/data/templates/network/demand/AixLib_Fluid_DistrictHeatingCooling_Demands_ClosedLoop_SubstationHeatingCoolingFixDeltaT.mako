  AixLib.Fluid.DistrictHeatingCooling.Demands.ClosedLoop.SubstationHeatingCoolingFixDeltaT demand${str(name)}(
...
<%def name="get_main_parameters()">
   heatDemand_max coolingDemand_max deltaT_heatingSet deltaT_coolingSet deltaT_heatingGridSet deltaT_coolingGridSet
</%def><%def name="get_aux_parameters()">
   cp_default dp_nominal m_flow_nominal
</%def><%def name="get_connector_names()">
   heatDemand T_supplyHeatingSet coolingDemand T_supplyCoolingSet
</%def>