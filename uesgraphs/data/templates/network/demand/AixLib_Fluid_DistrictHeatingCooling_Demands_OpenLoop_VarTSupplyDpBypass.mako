  AixLib.Fluid.DistrictHeatingCooling.Demands.OpenLoop.VarTSupplyDpBypass demand${str(name)}(
...
<%def name="get_main_parameters()">
   Q_flow_nominal dTDesign TReturn m_flo_bypass
</%def><%def name="get_aux_parameters()">
   sta_default cp_default dp_nominal deltaM tau energyDynamics massDynamics _m_flow_start _dp_start m_flow_nominal m_flow_small show_T allowFlowReversal
