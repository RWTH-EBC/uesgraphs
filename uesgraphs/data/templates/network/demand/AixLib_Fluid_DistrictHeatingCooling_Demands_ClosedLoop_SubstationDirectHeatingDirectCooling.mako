  AixLib.Fluid.DistrictHeatingCooling.Demands.ClosedLoop.SubstationDirectHeatingDirectCooling demand${str(name)}(
    ...
    T_supplyHeatingSet = ${str(round(T_supplyHeatingSet, 4))}
    )
...
<%def name="get_main_parameters()">
   heatDemand_max deltaT_heatingSet deltaT_heatingGridSet deltaT_coolingGridSet T_supplyHeatingSet
