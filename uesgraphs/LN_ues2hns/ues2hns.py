...
data_dir="LN_project\graph_to_hns\e15_geojson"


# Create graph and import GeoJSON
graph_ex15 = UESGraph()
graph_ex15.from_geojson(
    ...
    save_path="LN_project\graph_to_hns",
...
# print(f"Visualizations of network generation can be found in: {os.path.join(data_dir, 'visualizations')}")



# for edge in graph_ex15.edges:
#     print(graph_ex15.edges[edge])

## for getting graph from json - more universal
# graph.to_json(os.path.join(data_dir, 'simple_district_graph.json'))
# graph = UESGraph()
# graph.from_json(os.path.join(workspace, 'simple_district_graph.json',"nodes.json"), network_type='heating')
...
UESgraph_to_HNScsv(graph_ex15, "LN_project\graph_to_hns\hns_output" )
