model Ibpsa_low_temp_network_inputs
  "System model with inputs for network"
  extends Modelica.Icons.Example;

  Ibpsa_low_temp_network networkModel
  ...
  Modelica.Blocks.Sources.CombiTimeTable point_2Table(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Ibpsa_low_temp_network/Resources/Inputs/demand_point_2_heat.txt"
    ),
  ...
  Modelica.Blocks.Sources.CombiTimeTable point_3Table(
    ...
    columns={2},
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Ibpsa_low_temp_network/Resources/Inputs/demand_point_3_heat.txt"
    ),
    smoothness=Modelica.Blocks.Types.Smoothness.ContinuousDerivative,
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic)
    annotation(Placement(transformation(
  ...
  Modelica.Blocks.Sources.CombiTimeTable point_4Table(
    ...
    columns={2},
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Ibpsa_low_temp_network/Resources/Inputs/demand_point_4_heat.txt"
    ),
    smoothness=Modelica.Blocks.Types.Smoothness.ContinuousDerivative,
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic)
    annotation(Placement(transformation(
  ...
  Modelica.Blocks.Sources.CombiTimeTable supply_TIn_Table(
    ...
    columns={2},
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Ibpsa_low_temp_network/Resources/Inputs/supply_supply_TIn.txt"
    ),
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic)
    annotation(Placement(transformation(
      extent={{-2,-2},{2,2}},
  ...
  Modelica.Blocks.Sources.CombiTimeTable supply_dpIn_Table(
    ...
    columns={2},
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Ibpsa_low_temp_network/Resources/Inputs/supply_supply_dpIn.txt"
    ),
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic)
    annotation(Placement(transformation(
      extent={{-2,-2},{2,2}},
...
end Ibpsa_low_temp_network_inputs;
