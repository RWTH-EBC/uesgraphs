model Pinola_low_temp_network_inputs
  "System model with inputs for network"
  extends Modelica.Icons.Example;

  Pinola_low_temp_network networkModel
  ...
  Modelica.Blocks.Sources.CombiTimeTable B1Table(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Pinola_low_temp_network/Resources/Inputs/demand_B1_heat.txt"
    ),
  ...
  Modelica.Blocks.Sources.CombiTimeTable B2Table(
    ...
    columns={2},
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Pinola_low_temp_network/Resources/Inputs/demand_B2_heat.txt"
    ),
    smoothness=Modelica.Blocks.Types.Smoothness.ContinuousDerivative,
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic)
    annotation(Placement(transformation(
  ...
  Modelica.Blocks.Sources.CombiTimeTable B3Table(
    ...
    columns={2},
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Pinola_low_temp_network/Resources/Inputs/demand_B3_heat.txt"
    ),
    smoothness=Modelica.Blocks.Types.Smoothness.ContinuousDerivative,
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic)
    annotation(Placement(transformation(
  ...
  Modelica.Blocks.Sources.CombiTimeTable S1_TIn_Table(
    ...
    columns={2},
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Pinola_low_temp_network/Resources/Inputs/supply_S1_TIn.txt"
    ),
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic)
    annotation(Placement(transformation(
      extent={{-2,-2},{2,2}},
  ...
  Modelica.Blocks.Sources.CombiTimeTable S1_dpIn_Table(
    ...
    columns={2},
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Pinola_low_temp_network/Resources/Inputs/supply_S1_dpIn.txt"
    ),
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic)
    annotation(Placement(transformation(
      extent={{-2,-2},{2,2}},
  ...
  Modelica.Blocks.Sources.CombiTimeTable S2_TIn_Table(
    ...
    columns={2},
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Pinola_low_temp_network/Resources/Inputs/supply_S2_TIn.txt"
    ),
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic)
    annotation(Placement(transformation(
      extent={{-2,-2},{2,2}},
  ...
  Modelica.Blocks.Sources.CombiTimeTable S2_dpIn_Table(
    ...
    columns={2},
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Pinola_low_temp_network/Resources/Inputs/supply_S2_dpIn.txt"
    ),
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic)
    annotation(Placement(transformation(
      extent={{-2,-2},{2,2}},
...
equation
  ...
  connect(TGroundKusuda.port, TGroundIn.port)
    annotation (Line(
        points={
          {20, -80}, {20, -50}
        },
...
annotation (
  Documentation(
    ...
    <ul>
      <li><i>January 27, 2025&nbsp;</i> uesmodels 0.8.3:<br/>Auto-generated.</li>
    </ul>
    </html>"
    ),
  uses(AixLib),
...
end Pinola_low_temp_network_inputs;
